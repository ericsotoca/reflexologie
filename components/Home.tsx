    ...
    <div className="animate-fadeIn">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex flex-col items-center text-center">
          ...
          <h4 className="font-serif text-xl mb-2">Harmonie</h4>
          <p className="text-sm text-gray-500">Retrouvez l'équilibre entre votre corps et votre esprit.</p>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-50 flex flex-col items-center text-center">
          <div className="w-12 h-12 bg-beige rounded-full flex items-center justify-center mb-4 text-sage">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
          </div>
          <h4 className="font-serif text-xl mb-2">Sérénité</h4>
          <p className="text-sm text-gray-500">Un espace dédié à votre tranquillité intérieure.</p>
        </div>
      </div>
    </div>
  );
